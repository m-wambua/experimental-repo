...
%% Problem Definition
function [Best_score_ba,position_ba]=bee(SearchAgents_no,Max_iteration,Function_name) 
%% Problem Definition
...
nScoutBee = SearchAgents_no;                           % Number of Scout Bees
...
Best_score_ba=BestCost(it);
position_ba = BestSol.Position;
