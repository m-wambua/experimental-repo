...
function [Best_score_abc,position_abc,timing_abc]=abc(SearchAgents_no,Max_iteration,Function_name)
%% Problem Definition
tic
...
for it=1:MaxIt
    ...
    for m=1:nOnlooker
        ...
        % Select Source Site
        i=RouletteWheelSelection_abc(P);
...
Best_score_abc=BestCost(it);
position_abc=BestSol.Position;
%% Results
%f_min=[BestCost]
%figure;
